...
@property (nonatomic, strong)UIColor *lodingTextColor;
...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        //加载中label
        self.lodingLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 80, 40)];
        self.lodingLabel.text = @"加载中...";
        self.lodingLabel.font = [UIFont boldSystemFontOfSize:14];
        self.lodingLabel.textColor = self.lodingTextColor;
        self.lodingLabel.backgroundColor = [UIColor clearColor];
        self.lodingLabel.hidden = YES;
...
- (void)layoutSubviews
{
    self.lodingLabel.center = CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2);
    CGFloat xPoint = self.lodingLabel.center.x + self.lodingLabel.frame.size.width /2;
    self.activityIndicatorView.center = CGPointMake(xPoint, self.lodingLabel.center.y);
